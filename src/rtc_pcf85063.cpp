// PCF85063 RTC. AMOLED kit only — the LCD-128 has no on-board RTC, so its branch
// is a no-op stub that keeps main.cpp compiling unchanged (clock falls back to NTP).
...
// No on-board RTC; stubs keep the API surface identical.
