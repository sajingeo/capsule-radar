// CST9217 capacitive touch over I2C — used on the ESP32-S3-Touch-AMOLED-1.75.
// Ported from Waveshare's esp_lcd_touch_cst9217: read 10 bytes from reg 0xD000,
// validate ACK 0xAB, unpack the 12-bit X/Y of the first touch point.
#include "config.h"
